...
public class DayDetail extends JLabel {
	...
	public DayDetail(int mainNum, String cusName, String cusCarNum, String srvName, String cusTel, BookMain bMain, String mainStartDay, String mainStartTime, String mainEndDay, String mainEndTime, int year, int month,
			int days) {
